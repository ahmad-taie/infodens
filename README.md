...
Ngram bag of words | 4 | Ngram bag of words | Example: 1,2  (Uni-grams that appear at least twice) or 1,2,corpus.txt <li> N in ngram </li> <li> Cutoff frequency </li> <li> Training input for ngrams (Optional) </li> 
Ngram bag of POS | 5 | Ngram bag of POS | Example: 1,2 or 1,2,c:\taggedInput.txt  (Uni-grams that appear at least twice) <li> N in ngram </li> <li> Cutoff frequency </li> <li> Tagged POS input (Optional) </li> <li> Training input for ngrams (Optional. Previous argument becomes mandatory if it's provided) </li> 
Ngram bag of mixed words | 6 | Ngram bag of mixed words, sentences are tagged and only tags that start with J,N,V, or R are left, the others are actual words (Tagged with NLTK) | Example: 1,2 (Uni-grams that appear at least twice)  <li> N in ngram </li> <li> Cutoff frequency </li> <li> Tagged POS mixed input (Optional) </li> <li> Training input for ngrams (Optional. Previous argument becomes mandatory if it's provided) </li> 
Ngram bag of lemmas | 7 | Ngram bag of lemmas (lemmatized using NLTK WordNetLemmatizer) | Example: 1,2 (Uni-grams that appear at least twice) <li> N in ngram </li> <li> Cutoff frequency </li> <li> Lemmatized input (Optional) </li> <li> Training input for ngrams (Optional. Previous argument becomes mandatory if it's provided) </li> 
